...
// Validate ../../../app/api/auth/2fa/generate/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/auth/2fa/generate">> = Specific
  const handler = {} as typeof import("../../../app/api/auth/2fa/generate/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
